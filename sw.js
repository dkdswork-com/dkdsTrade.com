const CACHE='trade-memo-private-v5';
self.addEventListener('install',e=>e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./guide.html','./manifest.json'])).then(()=>self.skipWaiting())));
